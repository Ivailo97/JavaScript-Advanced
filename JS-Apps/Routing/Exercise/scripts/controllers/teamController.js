...
export async function joinTeamViewHandler() {
    /**
...
export async function leaveTeamViewHandler() {
    /**
...
export async function createTeamViewHandler() {
    /**
     * Load hbs templates
     */
...
export async function editTeamViewHandler() {
    /**
     * Load hbs templates
     */
    await applyCommon.call(this);
